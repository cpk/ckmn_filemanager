						...
						<div class="media-body">
							<h4 class="media-heading">
								<a href="<?php echo Router::url(array('controller' => $this->name, 'action' => 'read'));?>">
									<?php
									if($new < 4){
										echo '<strong>Thông báo Lorem dolor sit amet, consectetuer adipiscing elit</strong> <span class="badge badge-danger">New</span>';
									}else{
										echo 'Thông báo Lorem dolor sit amet, consectetuer adipiscing elit';
									}
									?>
								</a>
							</h4>
